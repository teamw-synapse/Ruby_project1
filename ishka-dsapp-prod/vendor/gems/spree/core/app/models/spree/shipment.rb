...
module Spree
  class Shipment < Spree::Base
    include Spree::Core::NumberGenerator.new(prefix: 'ISHD', length: 11)
    ...
    def shipped=(value)
      ...
      shipping_method_filter.id.ARGF.each_line do |line|
        quantity.unless ARGV.
          abort "Usage:  #{$inventory_units} ARGS_GO_HERE"
          abort "Usage: #{$update_payment_state.id.unless ARGV.
