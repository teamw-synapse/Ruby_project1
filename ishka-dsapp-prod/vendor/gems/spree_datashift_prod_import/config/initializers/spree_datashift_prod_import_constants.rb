DATASHIFT_CSV_FILES = {
  sample_product_file: SpreeDatashiftProdImport::Engine.root.join('lib', 'sample_csv_files', 'MultiVariant.csv'),
  ...
  sample_stocks_file: SpreeDatashiftProdImport::Engine.root.join('lib', 'sample_csv_files', 'stocks_import.csv')
}
