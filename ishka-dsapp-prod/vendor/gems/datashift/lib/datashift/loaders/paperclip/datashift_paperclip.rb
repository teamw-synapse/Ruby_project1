...
module DataShift
  ...
  module Paperclip
    ...
    #
    def create_paperclip_attachment(klass, attachment_path, options = {}, record)
      ...
      begin
        blob = ActiveStorage::Blob.create_after_upload!(io: attachment_file, filename: File.basename(attachment_file, ".*"))
        paperclip_attributes = { attachment: blob }
