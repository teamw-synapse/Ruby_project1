...
ActiveRecord::Schema.define(version: 2021_07_28_082645) do
  ...
  create_table "process_requests", force: :cascade do |t|
    t.string "process_type"
    t.boolean "processed", default: false
    t.integer "spree_user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["process_type"], name: "index_process_requests_on_process_type"
    t.index ["spree_user_id"], name: "index_process_requests_on_spree_user_id"
  end
  ...
  create_table "spree_commission_products", force: :cascade do |t|
    t.bigint "product_id"
    t.bigint "commission_setting_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["commission_setting_id"], name: "index_spree_commission_products_on_commission_setting_id"
    t.index ["product_id"], name: "index_spree_commission_products_on_product_id", unique: true
  end

# Could not dump table "spree_commission_settings" because of following StandardError
#   Unknown type 'mode_types' for column 'mode'
  ...
  create_table "spree_order_requests", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_id"], name: "index_spree_order_requests_on_order_id"
    t.index ["request_data"], name: "index_spree_order_requests_on_request_data", using: :gin
    t.index ["vendor_id"], name: "index_spree_order_requests_on_vendor_id"
  end
  ...
  create_table "spree_orders", id: :serial, force: :cascade do |t|
    ...
    t.index ["netsuite_id"], name: "index_spree_orders_on_netsuite_id"
    t.index ["netsuite_so"], name: "index_spree_orders_on_netsuite_so"
    t.index ["number"], name: "index_spree_orders_on_number", unique: true
    t.index ["ship_address_id"], name: "index_spree_orders_on_ship_address_id"
    t.index ["shopify_order_number"], name: "index_spree_orders_on_shopify_order_number"
  ...
  create_table "spree_products", id: :serial, force: :cascade do |t|
    ...
    t.boolean "netsuite_synced", default: false
    t.decimal "commission_price", precision: 10, scale: 2
    t.string "barcode"
    ...
    t.index ["netsuite_id"], name: "index_spree_products_on_netsuite_id"
    t.index ["payload_id"], name: "index_spree_products_on_payload_id"
  ...
  create_table "spree_stock_locations", id: :serial, force: :cascade do |t|
    ...
    t.index ["netsuite_id"], name: "index_spree_stock_locations_on_netsuite_id"
  ...
  create_table "spree_variants", id: :serial, force: :cascade do |t|
    ...
    t.index ["netsuite_id"], name: "index_spree_variants_on_netsuite_id"
  ...
  create_table "spree_vendors", id: :serial, force: :cascade do |t|
    ...
    t.index ["netsuite_id"], name: "index_spree_vendors_on_netsuite_id"
    t.index ["sku_prefix"], name: "index_spree_vendors_on_sku_prefix", unique: true, where: "(sku_prefix IS NOT NULL)"
  ...
  add_foreign_key "spree_commission_settings", "spree_vendors"
